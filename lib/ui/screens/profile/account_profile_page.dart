...
import 'package:flutter_application_1/ui/screens/profile/widgets/text_form_profile.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<UserBloc, UserState>(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Colors.white,
          title: const TextCustom(text: 'Updated profil', fontSize: 19),
          elevation: 0,
          leading: IconButton(
          ...
          actions: [
            TextButton(
              ...
              child: const TextCustom(text: 'save', color: ColorsFrave.primary, fontSize: 14)
            )
          ],
        ),
        body: Form(

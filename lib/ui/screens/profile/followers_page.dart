...
import 'package:flutter_application_1/domain/services/user_services.dart';
import 'package:flutter_application_1/ui/helpers/helpers.dart';
import 'package:flutter_application_1/ui/screens/profile/profile_another_user_page.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<UserBloc, UserState>(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
            backgroundColor: Colors.white,
            title: const TextCustom(text: 'followers', letterSpacing: .8, fontSize: 19),
            elevation: 0,
            leading: IconButton(
              splashRadius: 20,

...
import 'package:flutter_application_1/ui/screens/reels/widgets/modal_more_option.dart';
      ...
      body: Stack(
        children: [
          ...
          const Positioned(
            left: 15,
            top: 30,
            child: TextCustom(text: 'PA', color: Colors.white, isTitle: true, fontWeight: FontWeight.w600)
          ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    const TextCustom(text: 'Hello', color: Colors.white, fontWeight: FontWeight.w500, fontSize: 14.0),
                    const SizedBox(width: 10.0),
                    Container(
                      ...
                      child: const TextCustom(text: 'To follow', color: Colors.white, fontSize: 13, fontWeight: FontWeight.w500,),
                    )
                  ],
                ),
                ...
                Row(
                  children: const [
                    ...
                    SizedBox(width: 5.0),
                    TextCustom(text: '', color: Colors.white, fontSize: 14.0,)
                  ],
                )
              ],
            )
